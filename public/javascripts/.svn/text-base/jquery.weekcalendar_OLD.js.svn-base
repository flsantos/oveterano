(function($) {
   ...
   $.widget("ui.weekCalendar", {
      options: {
         ...
         longMonths : ['Jabne', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
         shortDays : ['Dom', 'Seg', 'Ter', 'Quia', 'Qui', 'Sex', 'Sáb'],
  ...
  TODO    if total height for an hour is less than 11px, there is a display problem.
      ...
      _setupEventCreationForWeekDay : function($weekDay) {
         ...
         $weekDay.mousedown(function(event) {
            ...
            if ($target.hasClass("wc-day-column-inner")) {
               ...
               $newEvent.css({lineHeight: (options.timeslotHeight - 2) + "px", fontSize: ((options.timeslotHeight / 2)-3) + "px"});
      ...
      _renderEvent: function (calEvent, $weekDay) {
         ...
         $weekDay.each(function(){
           ...
           $calEvent.css({lineHeight: (options.textSize + 2) + "px", fontSize: (options.textSize -3) + "px"});
