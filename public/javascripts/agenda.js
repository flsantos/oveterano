	...
	//Função simulando a inversa da $.param
	//Usage:
	/*
	...
	jQuery(document).ready(function(){
      ...
      data : function(start, end, callback) {
	   ...
	   jQuery.post("/ofertasearches/getgradedata", {horario : jQuery.deparam.querystring().horario}, function(result){
   ...
   function getEventData() {
      ...
      return {
         events:[
		   ...
		   {"title":"Horario Livre","end":"2011-08-03T10:00:00-03:00","start":"2011-08-03T08:00:00-03:00","id":1}
		]
